...
import { deleteDrug } from '../../../../src/redux/feature/drugSlice';
   ...
   return (
      <Card className={classes.card}>
         ...
         <div className={classes.overlay2}>
            <Button style={{ color: 'red' }} size="small" onClick={() => setCurrentId(drug._id)}><MoreHorizIcon fontSize="default" /></Button>
         </div>
